	...
	jQuery.extend({
      ...
      deferred = {}; // resolve | reject | notify    |state|then|promise
			...
			tuples.forEach(function(tuple, i) {
				var list = tuple[2],  // 创建一个队列  => 3  self对象的副本引用
				...
				// deferred[ resolve | reject | notify ]  延迟对象的状态，defferred.resolve()
				deferred[tuple[0]] = function() {
					deferred[tuple[0] + "With"](this === deferred ? promise : this, arguments);
					return this;
				};
        // list.fireWith 执行队列，调用队列中的处理函数并且给他们传参，绑定执行时上下文对象
